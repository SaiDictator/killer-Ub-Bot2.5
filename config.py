...
def main():
    print("T E A M    M O N S T E R   ! !")
    print("Hello!! Welcome to Monster Session Generator\n")
...
def generate_monster_session():
    print("!!! HELLBOT SESSION !!!")
    print("One session for all Monster's Project.")
    api_id = int(input("\nEnter APP ID here: "))
    api_hash = input("\nEnter API_HASH here: ")
